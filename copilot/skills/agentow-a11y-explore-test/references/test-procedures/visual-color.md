# Visual, color, zoom, and reflow

1. Test text/non-text contrast and information conveyed by color.
2. Resize the viewport to the WCAG-equivalent reflow width; do not use browser zoom alone as a
   substitute for viewport evidence.
